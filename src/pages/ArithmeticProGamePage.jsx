  ...
  if (gameState === 'waiting') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        <h1 className="text-4xl font-bold text-accent mb-4">Arithmetic Pro</h1>
        <p className="text-gray-400 mb-8">Solve multi-step calculations against the clock.</p>
        ...
        <div className="text-center">
          ...
          <form onSubmit={handleAnswerSubmit}>
            <input
              ...
              className="bg-transparent border-b-2 border-accent text-6xl text-center text-white w-64 focus:outline-none"
            />
          </form>
        </div>
      </div>
...
export default ArithmeticProGamePage;
